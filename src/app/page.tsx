            ...
            {[
              {
                value: "$500M+",
                label:
                  "Multifamily Underwriting & Acquisitions Experience",
              },
              {
              ...
              },
              {
                value: "Institutional",
                label:
                  "Former Private Equity & Institutional Lending Background",
              },
            ].map((item) => (
              <div
                key={item.label}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-navy-900/40 border border-navy-800/60 rounded-lg p-8 transition-all duration-300 hover:border-gold-500/20 hover:bg-navy-900/60">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <p className="text-lg font-display font-bold text-gold-400">
                    $14.5M
                  </p>
                </div>
                <div>
              ...
              <div className="border-t border-navy-800/40 pt-5">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  &mdash; Multifamily Sponsor, First-Time Agency Borrower
                </p>
              </div>
            </div>
            ...
            <div className="bg-navy-900/40 border border-navy-800/60 rounded-lg p-8 transition-all duration-300 hover:border-gold-500/20 hover:bg-navy-900/60">
              ...
              <div className="border-t border-navy-800/40 pt-5">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  &mdash; Private Investor, 500+ Unit Portfolio
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Every deal is underwritten to the same standards used by top PE firms and agency lenders.",
                },
                {
                  icon: Handshake,
                  title: "Aligned Interests",
                  description:
                    "We earn your trust by delivering results. Our advisory fee is credited toward your engagement.",
                },
                {
                  icon: FileSearch,
                  title: "Lender Relationships",
                  description:
                    "Direct access to agency, bridge, and CMBS lenders through established capital markets relationships.",
                },
              ].map((item) => (
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {[
              {
                ...
                title: "Deal Review",
                description:
                  "We review your deal within 24-48 hours.",
              },
              {
                step: "2",
                icon: Settings,
                ...
                description:
                  "We structure optimal financing options.",
              },
              {
                step: "3",
                icon: Handshake,
              ...
              },
              {
                ...
                title: "Loan Quotes",
                description:
                  "You receive tailored loan quotes.",
              },
            ].map((item) => (
              <div
                key={item.step}
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gold-400/70 mt-1">
              Initial deal review within 24-48 hours.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 leading-relaxed max-w-2xl mx-auto">
              Download our free Multifamily Underwriting Model and instantly
              see whether your acquisition or refinance pencils out. Built
              with institutional-grade formulas and a built-in Deal Quality
              Assessment.
            </p>
          </div>
      ...
      <section className="px-6 py-20 md:py-28 bg-gradient-to-b from-navy-900/30 to-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 leading-relaxed mb-8 max-w-xl mx-auto">
            ...
            property and business plan. Our team will review your submission
            and respond within 24&ndash;48 hours.
          </p>
          <Link
            href="/submit-deal"
            className="inline-flex items-center justify-center px-9 py-4 bg-gold-500 text-navy-950 font-bold text-base tracking-wide uppercase rounded transition-all duration-300 hover:bg-gold-400 hover:shadow-lg hover:shadow-gold-500/25"
...
export default function Home() {
  return (
    <>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-center gap-4">
            ...
            >
              ...
              <span className="text-xs text-gray-500 mt-1">No obligation. 100% confidential.</span>
            </div>
            <div className="flex flex-col items-center">
              <Link
                href="/book-call"
              ...
              <span className="text-xs text-gold-400 mt-1 italic">Limited availability for consultations</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-10 text-center">
        <p className="text-gray-400 max-w-3xl mx-auto leading-relaxed">
          Experience working with agency lenders including Fannie Mae and Freddie Mac, as well as leading bridge lenders.
        </p>
      </section>
      ...
      <section className="px-6 py-20 md:py-28 bg-navy-900/20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              We don&apos;t just quote loans &mdash; we structure the optimal capital stack for your deal.
            </p>
          </div>
      ...
      <section className="px-6 py-20 md:py-28 bg-gradient-to-b from-navy-900/30 to-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xs text-gray-500 mt-3">No obligation. 100% confidential.</p>
        </div>
      </section>
    </>
  );
